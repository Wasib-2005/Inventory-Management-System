    ...
    <div>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-wrap gap-2 sm:gap-3 items-stretch sm:items-center">
          {/* Search */}
          <div className="relative flex-[1_1_100%] sm:flex-1 min-w-0 order-1">
            <svg
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 min-h-10 px-3 sm:px-4 rounded-md text-[12px] font-medium border transition-colors shrink-0 order-2 ${
              filterOpen
          ...
          <div className="relative shrink-0 order-4 sm:order-3 w-full sm:w-auto">
            <select
              ...
              className="h-10 w-full sm:w-auto min-w-0 pl-3 pr-8 rounded-md bg-transparent text-emerald-400 text-[12px] font-medium border border-emerald-700/40 hover:bg-emerald-900/20 transition-colors appearance-none cursor-pointer focus:outline-none"
            >
              {sortOptions.map((opt) => (
                <option
                  key={opt}
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 min-h-10 px-3 sm:px-4 rounded-md bg-[#1D9E75] text-white text-[12px] font-medium border border-[#0F6E56] hover:bg-[#0F6E56] transition-colors shrink-0 whitespace-nowrap order-3 sm:order-4"
          >
